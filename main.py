...
'''
    ...
    G = {
        0: {1: 9, 2: 10, 3: 9},  # Vertex 0 has edges to vertices 1 and 2 with weights 2 and 3
        1: {2: 20, 3: 3},  # Vertex 1 has an edge to vertex 3 with weight 1
        2: {1: 30, 3: 30},  # Vertex 2 has an edge to vertex 3 with weight 4
        3: {1: 11, 2: 0}  # Vertex 3 has an edge to vertex 0 with weight 5
    }
    '''
    # Define a directed graph as a dictionary
    G = {
        0: {1: 2, 2: 3},  # Vertex 0 has edges to vertices 1 and 2 with weights 2 and 3
        1: {3: 1},  # Vertex 1 has an edge to vertex 3 with weight 1
        2: {3: 4},  # Vertex 2 has an edge to vertex 3 with weight 4
        3: {0: 5}  # Vertex 3 has an edge to vertex 0 with weight 5
    }
    '''
